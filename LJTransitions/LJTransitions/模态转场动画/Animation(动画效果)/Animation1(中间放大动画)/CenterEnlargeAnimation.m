...
@interface CenterEnlargeAnimation ()

@property (nonatomic, strong) UIView *bubbleView;

@end

@implementation CenterEnlargeAnimation

- (instancetype)initWithPresented:(HYBTransitionPresented)presentedCallback dismissed:(HYBTransitionDismiss)dismissCallback
{
    self = [super initWithPresented:presentedCallback dismissed:dismissCallback];
    if (self) {
