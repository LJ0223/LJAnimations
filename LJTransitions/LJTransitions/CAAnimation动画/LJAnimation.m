...
+ (CALayer *)replicatorLayer_Circle{
    ...
    animationGroup.animations = @[[LJAnimation alphaAnimation],[LJAnimation scaleAnimation]];
...
+ (CALayer *)replicatorLayer_Wave{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    [shape addAnimation:[LJAnimation scaleAnimation1] forKey:@"scaleAnimation"];
...
+ (CALayer *)replicatorLayer_Triangle{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    shape.lineWidth = 1;
    [shape addAnimation:[LJAnimation rotationAnimation:transX] forKey:@"rotateAnimation"];
...
+ (CALayer *)replicatorLayer_Grid{
    ...
    CAAnimationGroup *animationGroup = [CAAnimationGroup animation];
    animationGroup.animations = @[[LJAnimation scaleAnimation1], [LJAnimation alphaAnimation]];
